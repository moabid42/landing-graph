...
![A DDR3 memory slot on a blue circuit board, with a paper label reading MEMORY laid across it](./blog/did-someone-say-memory/01.webp)
...
![A process memory layout: command line arguments and the stack growing down, the heap growing up to meet it, and below them the uninitialised, initialised and text segments](./blog/did-someone-say-memory/02.webp)
...
![The woman yelling at a confused cat meme](./blog/did-someone-say-memory/03.webp)
